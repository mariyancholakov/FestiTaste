...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      className="rounded-[32px] border border-border bg-white p-6 shadow-sm sm:p-8"
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="space-y-2">
          ...
          <input
            ...
            name="ime"
            required
            className="h-12 w-full rounded-2xl border border-border bg-white px-4 text-sm text-text-base outline-none ring-1 ring-transparent focus:border-primary focus:ring-primary/30"
          />
        </label>
        <label className="space-y-2">
      ...
      <button
        type="submit"
        className="mt-6 inline-flex h-12 w-full items-center justify-center rounded-full bg-primary px-6 text-sm font-semibold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-rust"
      >
        Изпрати запитване
      </button>
