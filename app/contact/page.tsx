  ...
  return (
    <div className="pb-24">
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-[36px] bg-gradient-to-r from-dark-green via-primary to-accent px-6 py-14 sm:px-10">
          <SectionTitle
            eyebrow="Contact"
            theme="light"
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        <div className="space-y-6">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-7 text-dark-green/70">
                    {card.value}
                  </p>
                </div>
              </div>
          ...
          <article className="rounded-[28px] border border-dark-green/10 bg-white p-6 shadow-[0_18px_50px_rgba(27,67,50,0.06)]">
            <h2 className="text-lg font-semibold text-dark-green">
              Социални мрежи
            </h2>
            <div className="mt-4 flex gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex rounded-full bg-cream px-4 py-3 text-sm font-semibold text-primary transition-all duration-200 hover:scale-[1.02] hover:bg-primary hover:text-white"
